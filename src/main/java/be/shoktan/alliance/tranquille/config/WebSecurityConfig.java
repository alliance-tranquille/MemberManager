...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authenticationEntryPoint(new LoginUrlAuthenticationEntryPoint("/login/discord")).and().logout()
    ...
    private Filter ssoFilter() {
        ...
        AccessTokenProvider accessTokenProvider = new AccessTokenProviderChain(Collections.<AccessTokenProvider>singletonList((AuthorizationCodeAccessTokenProvider) authAccessProvider));
